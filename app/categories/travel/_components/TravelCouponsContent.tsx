...
const STORES = [
  { id: "latam-airlines", name: "Latam Airlines", logo: "/latam-airlines-coupon-code.webp", coupons: 8, discount: "Up to 12% OFF" }
];
              ...
              <div className="bg-white rounded-2xl border border-[#f0f0f0] shadow-sm overflow-hidden mb-5">
                <div className="flex flex-col md:flex-row">
                  <div className="flex-1 p-7 md:p-8">
                    <h1 className="text-black font-extrabold text-3xl">Travel Coupons & Deals</h1>
                  ...
                  <div className="md:w-[45%] h-[200px] md:h-auto overflow-hidden">
                    <img src="/travel-coupon-codes.webp" alt="Travel Coupons" className="w-full h-full object-cover" />
                  </div>
                </div>
              </div>
