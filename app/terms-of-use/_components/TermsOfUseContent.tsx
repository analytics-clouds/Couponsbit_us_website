    ...
    <div className="min-h-screen bg-white font-sans selection:bg-[#19798d] selection:text-white">
      ...
      <section className="relative w-full pt-20 pb-24 bg-gradient-to-br from-[#0f5a6b] to-[#19798d] mt-[64px] text-center">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            <span className="text-[#19798d] font-bold text-sm tracking-wide">Please Read Before Using Our Platform</span>
          </motion.div>
      ...
      <section className="bg-gradient-to-br from-[#19798d] to-[#0f5a6b] py-16 text-center">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link href="/privacy-policy" className="w-full sm:w-auto px-9 py-4 border-2 border-white text-white rounded-full font-bold text-base hover:bg-white hover:text-[#19798d] transition-all text-center">
              Read Privacy Policy
            </Link>
          </div>
        </div>
