      ...
      <div className="container mx-auto px-4 max-w-6xl py-12 space-y-16">
        ...
        <section>
          <div className="flex items-center gap-5 mb-10">
            ...
            <Link href="/stores/bluehost" className="shrink-0 text-[#19798d] font-black text-sm border border-[#19798d] rounded-full px-5 py-2 hover:bg-[#19798d] hover:text-white transition-all duration-200">View All →</Link>
          </div>
            ...
            {[
              ...
              <div key={i} className="flex bg-white border border-gray-100 rounded-[28px] overflow-hidden shadow-sm hover:shadow-md transition-all duration-300">
                ...
                <div className="flex-1 p-5 flex flex-col justify-between min-w-0">
                  ...
                  <Link href="/stores/bluehost"><button className="mt-3 w-full bg-[#19798d] hover:bg-[#0f5a6b] text-white text-sm font-bold py-2.5 rounded-xl transition-all">Get Deal</button></Link>
                </div>
              </div>
            ))}
          </div>
        ...
        <section>
          <div className="flex items-center gap-5 mb-10">
            ...
            <div className="flex-1 h-px bg-gradient-to-r from-[#19798d]/30 to-transparent" />
            <Link href="/stores/driffle" className="shrink-0 text-[#19798d] font-black text-sm border border-[#19798d] rounded-full px-5 py-2 hover:bg-[#19798d] hover:text-white transition-all duration-200">View All →</Link>
          </div>
            ...
            {[
              ...
              <div key={i} className="bg-white border-y border-r border-l-4 border-gray-100 border-l-[#19798d] rounded-r-[24px] rounded-l-sm p-6 flex flex-col justify-between min-h-[300px] hover:border-y-[#19798d] hover:border-r-[#19798d] hover:shadow-lg transition-all duration-300">
                ...
                <div className="mt-4 pt-4 border-t border-gray-100 flex items-center justify-between">
                  ...
                  <Link href="/stores/driffle"><button className="bg-[#19798d] hover:bg-[#0f5a6b] text-white text-xs font-bold px-5 py-2.5 rounded-xl transition-all">Get Deal</button></Link>
                </div>
              </div>
            ))}
          </div>
        ...
        <section>
          <div className="mb-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link href="/stores/latam-airlines" className="text-[#19798d] font-black text-sm border border-[#19798d] rounded-full px-5 py-2 hover:bg-[#19798d] hover:text-white transition-all duration-200 ml-4">View All →</Link>
            </div>
          </div>
            ...
            {[
              ...
              <div key={i} className="w-[240px] shrink-0 bg-white border border-gray-100 rounded-[28px] p-5 shadow-sm flex flex-col justify-between h-[300px] snap-start hover:shadow-md transition-shadow duration-300 overflow-hidden">
                ...
                <div>
                  ...
                  <Link href="/stores/latam-airlines"><button className="w-full bg-[#19798d] hover:bg-[#0f5a6b] text-white font-extrabold text-sm py-3.5 rounded-2xl transition-colors">View Offer</button></Link>
                </div>
              </div>
            ))}
          </div>
        ...
        <section>
          <div className="flex items-center gap-5 mb-10">
            ...
            <div className="flex-1 h-px bg-gradient-to-r from-[#19798d]/30 to-transparent" />
            <Link href="/stores/lyca-mobile" className="shrink-0 text-[#19798d] font-black text-sm border border-[#19798d] rounded-full px-5 py-2 hover:bg-[#19798d] hover:text-white transition-all duration-200">View All →</Link>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
            {[
              ...
              <div key={i} className="bg-white border border-[#f0f0f0] rounded-[28px] p-6 flex flex-col hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                ...
                <Link href="/stores/lyca-mobile"><button className="w-full bg-[#19798d] hover:bg-[#0f5a6b] text-white font-bold text-sm py-3 rounded-xl transition-all">View Offer</button></Link>
              </div>
            ))}
          </div>
        </section>
        ...
        <section>
          <div className="flex items-center gap-5 mb-10">
            ...
            <div className="flex-1 h-px bg-gradient-to-r from-[#19798d]/30 to-transparent" />
            <Link href="/stores/sintra" className="shrink-0 text-[#19798d] font-black text-sm border border-[#19798d] rounded-full px-5 py-2 hover:bg-[#19798d] hover:text-white transition-all duration-200">View All →</Link>
          </div>
            ...
            {[
              ...
              <div key={i} className="relative bg-white rounded-[20px] overflow-visible shadow-md hover:shadow-2xl hover:-translate-y-2 transition-all duration-300" style={{ filter: "drop-shadow(0 4px 16px rgba(25,121,141,0.10))" }}>
                ...
                <div className="rounded-b-[20px] bg-white px-6 pt-7 pb-6">
                  ...
                  <Link href="/stores/sintra"><button className="w-full bg-[#19798d] hover:bg-[#0f5a6b] text-white font-bold text-sm py-3 rounded-xl transition-all">Get Coupon →</button></Link>
                </div>
              </div>
            ))}
          </div>
