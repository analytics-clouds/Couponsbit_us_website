...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://couponsbit.us/stores/reolink",
    languages: {
      "en-US": "https://couponsbit.us/stores/reolink",
      "x-default": "https://couponsbit.us/stores/reolink",
    },
  },
...
const reolinkSchema = {
  ...
  "@graph": [
    {
      "@type": "WebPage",
      "@id": "https://couponsbit.us/stores/reolink#webpage",
      url: "https://couponsbit.us/stores/reolink",
      ...
      breadcrumb: {
        "@id": "https://couponsbit.us/stores/reolink#breadcrumb",
      },
    },

    {
      "@type": "ItemList",
      "@id": "https://couponsbit.us/stores/reolink#offerlist",
...

    {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          item: "https://couponsbit.us/stores/reolink",
        },
      ],
    },
  ],
