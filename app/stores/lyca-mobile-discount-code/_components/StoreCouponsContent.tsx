            ...
            <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
              ...
              <div className="lg:w-[45%]">
                <div className="flex flex-col sm:flex-row items-start gap-6 mb-0 md:mb-8">
                  <a href="https://www.lycamobile.co.uk/en/affiliate-coupon-code-10/?im_ref=VlX35y3mRxyZUPhT3qXyp0onUkr2fZV5qV790U0&utm_campaign=4303217&utm_content=Analytics%20clouds&utm_source=impact&utm_medium=Affiliate&irgwc=1&afsrc=1" target="_blank" rel="nofollow noopener noreferrer">
              ...
              <div className="hidden md:block flex-1">
                <div className="relative rounded-2xl overflow-hidden h-[250px] shadow-lg group">
                  ...
                  <div className="absolute inset-0 transition-opacity duration-500" style={{ opacity: activeSlide === 0 ? 1 : 0 }}>
                    <a href="https://www.lycamobile.co.uk/en/affiliate-coupon-code-10/?im_ref=VlX35y3mRxyZUPhT3qXyp0onUkr2fZV5qV790U0&utm_campaign=4303217&utm_content=Analytics%20clouds&utm_source=impact&utm_medium=Affiliate&irgwc=1&afsrc=1" target="_blank" rel="nofollow noopener noreferrer" className="block w-full h-full">
          ...
          <button type="button" onClick={() => handleCopy("LYCA 10")} className="w-full lg:w-auto flex items-center justify-between gap-3 border-2 border-dashed border-[#056bfa] rounded-2xl px-4 py-2.5 bg-white hover:bg-[#e8f6f8] transition-colors">
              ...
              <div className="lg:w-[35%] space-y-8">
                ...
                <div className="bg-white rounded-[32px] border border-[#f0f0f0] p-8 shadow-sm">
                  ...
                  <a href="https://www.lycamobile.co.uk/en/affiliate-coupon-code-10/?im_ref=VlX35y3mRxyZUPhT3qXyp0onUkr2fZV5qV790U0&utm_campaign=4303217&utm_content=Analytics%20clouds&utm_source=impact&utm_medium=Affiliate&irgwc=1&afsrc=1" target="_blank" rel="nofollow noopener noreferrer" className="text-[#056bfa] font-black text-sm flex items-center gap-1.5 hover:underline decoration-2">
                    Visit Store <ExternalLink className="w-3.5 h-3.5" />
                  </a>
                </div>
          ...
          <div className="space-y-6">
            {COUPONS.slice(0, 5).map((deal, i) => (
              <div key={i} className="flex items-center gap-4 group cursor-pointer">
                ...
                <a href="https://www.lycamobile.co.uk/en/affiliate-coupon-code-10/?im_ref=VlX35y3mRxyZUPhT3qXyp0onUkr2fZV5qV790U0&utm_campaign=4303217&utm_content=Analytics%20clouds&utm_source=impact&utm_medium=Affiliate&irgwc=1&afsrc=1" target="_blank" rel="nofollow noopener noreferrer" aria-label={`Get Lyca Mobile deal: ${deal.heading}`} className="bg-[#e8f6f8] text-[#0451c4] px-3.5 py-2 rounded-xl text-[12px] font-black uppercase tracking-widest hover:bg-[#056bfa] hover:text-white transition-all active:scale-90">Get Deal</a>
              </div>
            ))}
          </div>
        </div>
