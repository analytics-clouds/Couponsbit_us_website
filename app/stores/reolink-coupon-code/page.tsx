...
const reolinkSchema = {
  ...
  "@graph": [
    {
      "@type": "WebPage",
      "@id": "https://www.couponsbit.us/stores/reolink-coupon-code#webpage",
      url: "https://www.couponsbit.us/stores/reolink-coupon-code",
      ...
      breadcrumb: {
        "@id": "https://www.couponsbit.us/stores/reolink-coupon-code#breadcrumb",
      },
    },

    {
      "@type": "ItemList",
      "@id": "https://www.couponsbit.us/stores/reolink-coupon-code#offerlist",
...

    {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          item: "https://www.couponsbit.us/stores/reolink-coupon-code",
        },
      ],
    },
  ],
