...
const allStores = [
  { name: "Stubhub",         id: "stubhub",         category: "More",        coupons: 7,  logo: "/stubhub-coupon-code.webp",        discount: "Flat 10% OFF",     popular: false },
  { name: "Viagogo",         id: "viagogo",         category: "More",        coupons: 6,  logo: "/viagogo-coupon-code.webp",         discount: "Starting at $332", popular: false },
  { name: "Latam Airlines",  id: "latam-airlines",  category: "Travel",      coupons: 6,  logo: "/latam-airlines-coupon-code.webp",  discount: "Up to 40% OFF",    popular: false },
  { name: "Rayneo",          id: "rayneo",          category: "Electronics", coupons: 8,  logo: "/reyneo-coupon-code.webp",          discount: "Save $130 OFF",    popular: false },
  { name: "Driffle",         id: "driffle",         category: "More",        coupons: 9,  logo: "/driffle-coupon-code.webp",         discount: "Up to 95% OFF",    popular: false },
  { name: "Lyca Mobile",     id: "lyca-mobile",     category: "More",        coupons: 11, logo: "/lyca-mobile-coupon-code.webp",     discount: "Up to 69% OFF",    popular: false },
  { name: "Bluehost",        id: "bluehost",        category: "More",        coupons: 10, logo: "/bluehost-coupon-code.webp",        discount: "Up to 69% OFF",    popular: false },
  { name: "Reolink",         id: "reolink",         category: "More",        coupons: 8,  logo: "/reolink-coupon-code.webp",         discount: "Up to 50% OFF",    popular: false },
  { name: "Envato Elements", id: "envato-elements", category: "More",        coupons: 7,  logo: "/envato-coupon-code.webp",          discount: "Up to 50% OFF",    popular: false },
  { name: "Sintra",          id: "sintra",          category: "More",        coupons: 6,  logo: "/sintra-coupon-code.webp",          discount: "Up to 70% OFF",    popular: false }
];
