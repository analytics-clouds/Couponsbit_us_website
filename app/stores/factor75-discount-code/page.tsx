...
const factor75Schema = {
  ...
  "@graph": [
      ...
      itemListElement: [
        {
          ...
          item: {
            "@type": "Offer",
            name: "Factor75 Healthy Eating Deal – Up to $130 OFF + FREE Breakfast for 1 Year",
        ...
        },
        {
          ...
          item: {
            "@type": "Offer",
            name: "Factor75 Limited-Time Promotion – Up to $126 OFF",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://www.couponsbit.us/stores/factor75-discount-code#faq",
      mainEntity: [
        {
          "@type": "Question",
          name: "What is UniPin?",
