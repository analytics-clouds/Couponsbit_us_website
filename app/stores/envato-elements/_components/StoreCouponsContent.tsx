          ...
          <a href="http://1.envato.market/c/4303217/298927/4662?subId1=1015&u=https%3A%2F%2Felements.envato.com%2F" target="_blank" rel="noopener noreferrer" className="w-full lg:w-auto bg-[#0077b6] hover:bg-[#005f91] text-white font-bold text-[18px] sm:text-lg px-6 sm:px-10 py-3 sm:py-4 rounded-2xl shadow-md transition-all duration-300 text-center">Get Deal</a>
              ...
              <div className="lg:w-[35%] space-y-8">
                ...
                <div className="bg-white rounded-[32px] border border-[#f0f0f0] p-8 shadow-sm">
                  ...
                  <a href="http://1.envato.market/c/4303217/298927/4662?subId1=1015&u=https%3A%2F%2Felements.envato.com%2F" target="_blank" rel="noopener noreferrer" className="text-[#19798d] font-black text-sm flex items-center gap-1.5 hover:underline decoration-2">
      ...
      <div className="prose max-w-none">
        ...
        <div className={cn("text-gray-500 font-bold leading-relaxed space-y-6 relative", !isReadMore && "max-h-[500px] overflow-hidden")}>
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-black text-[#19798d] mb-4">Know More About Envato Elements</h3>
          ...
          <div className="space-y-8 bg-white p-10 rounded-[40px] border border-[#f0f0f0] shadow-sm my-12">
            <h3 className="text-xl font-black text-[#19798d] mb-8">How to Use an Envato Elements Coupon Code</h3>
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-black text-[#19798d] mb-4">Why Creators Choose Envato Elements</h3>
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-black text-[#19798d] mb-4">Commercial Licensing Benefits</h3>
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-black text-[#19798d] mb-4">Best Ways to Save on Envato Elements</h3>
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-black text-[#19798d] mb-4">Why Use Couponsbit for Envato Elements Deals?</h3>
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-black text-[#19798d] mb-4">Create More While Spending Less</h3>
          ...
          <div className="space-y-6">
            {COUPONS.slice(0, 5).map((deal, i) => (
              <div key={i} className="flex items-center gap-4 group cursor-pointer">
                <div className="w-12 h-12 bg-[#f8fafc] rounded-2xl flex items-center justify-center text-[#19798d] font-black text-xl italic shadow-inner">E</div>
                ...
                <a href="http://1.envato.market/c/4303217/298927/4662?subId1=1015&u=https%3A%2F%2Felements.envato.com%2F" target="_blank" rel="noopener noreferrer" className="bg-[#e8f6f8] text-[#19798d] px-3.5 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-[#19798d] hover:text-white transition-all active:scale-90 text-center">GET</a>
              </div>
            ))}
          </div>
        </div>
