                ...
                <div className="flex flex-col sm:flex-row items-start gap-6 mb-0 md:mb-8">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm leading-relaxed max-w-[400px] text-justify">
                      Find verified Viagogo discount codes for August 2026 and secure tickets to the biggest live events. Coachella from $603, World Cup US vs Paraguay from $120, Governors Ball from $332 & concerts from just $49. Limited seats — book before they sell out.
                    </p>
                  </div>
                </div>
